...
>
> 본 레포지토리는 실제 요금제 가입자를 대상으로 가족 간의 데이터를 합리적으로 배분하고, 부모가 자녀의 데이터 사용 환경을 설계할 수 있도록 돕는 비즈니스 로직의 핵심부를 담당합니다. **헥사고날 아키텍처**를 채택하여 외부 기술 변화로부터 도메인 로직을 보호하며, 복잡한 데이터 집계 및 정책 엔진 구현에 집중하고 있습니다.
