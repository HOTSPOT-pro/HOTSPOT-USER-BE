...
class UpdateBlockPolicyServiceImplTest {
    ...
    @Mock
    private PolicyChangedOutboxPublisher policyChangedOutboxPublisher;
    ...
    void updateSuccess() {
        ...
        given(blockPolicyRepository.findByBlockPolicyId(POLICY_ID))
                .willReturn(existingPolicy);

        given(blockPolicyRepository.save(any(BlockPolicy.class)))
                .willAnswer(invocation -> invocation.getArgument(0));

        BlockPolicyResponse response =
                service.update(request, POLICY_ID, MEMBER_ID, FAMILY_ID);
        ...
        verify(policyChangedOutboxPublisher)
                .publish(any(BlockPolicy.class), anyLong());
    }
    ...
    void updateWithSnapshotAndNullTypeSuccess() {
        ...
        BlockPolicyRequest request =
                new BlockPolicyRequest("수정된 이름", null, snapshot, "수정된 설명", true);
    ...
    void updateWithSnapshotSuccess() {
        ...
        BlockPolicyRequest request =
                new BlockPolicyRequest("수정된 이름", PolicyType.SCHEDULED, snapshot, "수정된 설명", true);
