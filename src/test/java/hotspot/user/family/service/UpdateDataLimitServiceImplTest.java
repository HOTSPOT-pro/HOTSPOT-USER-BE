...
class UpdateDataLimitServiceImplTest {
    ...
    void updateDataLimitSuccess() {
        ...
        UpdateDataLimitRequest request =
                new UpdateDataLimitRequest(familyId, subId, newDataLimitGb, false);

        FamilySubscription familySub = createFamilySubscription(familyId, subId, 1000L);
        ...
        verify(eventPublisher, times(1)).publishEvent(any(SubscriptionUnlockedEvent.class));
        verify(eventPublisher, times(1)).publishEvent(any(FamilySubLimitChangedEvent.class));
    }
    ...
    void updateDataLimitToZeroAndLock() {
        ...
        UpdateDataLimitRequest request =
                new UpdateDataLimitRequest(familyId, subId, newDataLimitGb, true);
        ...
        verify(eventPublisher, times(1)).publishEvent(any(SubscriptionLockedEvent.class));
        verify(eventPublisher, times(1)).publishEvent(any(FamilySubLimitChangedEvent.class));
    }
    ...
    void updateDataLimitFailNotOwner() {
        UpdateDataLimitRequest request =
                new UpdateDataLimitRequest(1L, 100L, 5L, false);
    ...
    void updateDataLimitFailDifferentFamily() {
        ...
        UpdateDataLimitRequest request =
                new UpdateDataLimitRequest(requesterFamilyId, subId, 5L, false);

        FamilySubscription familySub = createFamilySubscription(targetFamilyId, subId, 1000L);
        given(familySubscriptionRepository.findBySubId(subId)).willReturn(Optional.of(familySub));
    ...
    void updateDataLimitFailNotFound() {
        UpdateDataLimitRequest request =
                new UpdateDataLimitRequest(1L, 999L, 5L, false);
    ...
    void updateDataLimitToUnlimited() {
        ...
        UpdateDataLimitRequest request =
                new UpdateDataLimitRequest(1L, 100L, unlimitedGb, false);

        FamilySubscription familySub = createFamilySubscription(1L, 100L, 1000L);
        ...
        verify(subscriptionRepository, times(1)).updateLockedStatus(eq(100L), eq(false));
    ...
    void updateDataLimitFailInvalidValue() {
        ...
        UpdateDataLimitRequest request =
                new UpdateDataLimitRequest(1L, 100L, invalidLimit, false);
    ...
    void updateDataLimitFailExceedsFamilyAmount() {
        ...
        long newDataLimitGb = 10L;
        long familyDataAmountKb = 5L * 1024L * 1024L;

        UpdateDataLimitRequest request =
                new UpdateDataLimitRequest(familyId, subId, newDataLimitGb, false);

        FamilySubscription familySub =
                createFamilySubscription(familyId, subId, 1000L, familyDataAmountKb);
    ...
    private FamilySubscription createFamilySubscription(Long familyId,
                                                        Long subId,
                                                        long currentLimit,
    ...
    private FamilySubscription createFamilySubscription(Long familyId,
                                                        Long subId,
                                                        long currentLimit) {
        return createFamilySubscription(
                familyId,
                subId,
                currentLimit,
                100L * 1024L * 1024L
